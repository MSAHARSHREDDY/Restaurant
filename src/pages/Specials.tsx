            ...
            <Reveal className="h-full">
              <div className="glass-panel p-8 md:p-10 rounded-2xl h-full flex flex-col items-start justify-start border-l-4 border-l-gold-500 bg-gradient-to-br from-gold-500/5 to-transparent relative overflow-hidden">
                ...
                <div className="relative z-10 w-full">
                  ...
                  <h3 className="heading-serif text-3xl md:text-4xl text-white mb-6">Flight Status & Updates</h3>
                  <ul className="space-y-6">
                    ...
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">We've just updated our menu with culinary delights inspired by our recent flights to Tokyo and Paris.</p>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                {specialItems.map((item, i) => (
                  <div key={i} className="glass-panel p-6 rounded-xl transition-colors group border border-white/5 hover:border-gold-500/30 flex flex-col relative overflow-hidden">
                    ...
                    <button
                      ...
                      className="mt-auto w-full py-2 bg-white/5 hover:bg-gold-500/20 text-gold-500 rounded border border-gold-500/30 hover:border-gold-500 flex items-center justify-center gap-2 transition-all text-xs tracking-wider uppercase cursor-pointer"
                    >
