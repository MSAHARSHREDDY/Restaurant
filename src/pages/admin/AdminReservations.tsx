...
export function AdminReservations() {
  ...
  const loadReservations = async () => {
    ...
    try {
      ...
      console.error(e);
      toast.error("Failed to load in-flight reservations.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-gradient-to-r from-dark-900 to-dark-950 border border-white/10 rounded-2xl p-6 shadow-xl gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Approve, update layouts, and allocate VIP seats to flight customers.</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 font-sans">
        <div className="bg-dark-900 border border-white/5 rounded-xl p-5 flex items-center justify-between">
          <div>
            <p className="text-gray-500 text-xs tracking-wider uppercase font-mono">Today's Reserved Flights</p>
        ...
        <div className="bg-dark-900 border border-white/5 rounded-xl p-5 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-2">Elite flight seating ratio</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="relative md:col-span-2">
          <input 
            ...
            className="w-full bg-dark-900 border border-white/10 rounded-xl px-4 py-3 pl-10 text-sm text-white placeholder-gray-500 outline-none focus:border-gold-500/50"
          />
        ...
        <div>
          <select
            ...
            className="w-full h-full bg-dark-900 border border-white/10 rounded-xl px-3 py-3 text-sm text-white select-none cursor-pointer outline-none focus:border-gold-500"
          >
                      ...
                      {res.status === 'Pending' && (
                        <>
                          <button
                            ...
                            className="p-1.5 bg-emerald-500/10 hover:bg-emerald-500 text-emerald-400 hover:text-dark-950 rounded transition-all cursor-pointer"
        ...
        <div className="fixed inset-0 bg-dark-950/85 backdrop-blur-sm flex items-center justify-center p-4 z-[999]">
          <div className="bg-dark-900 border border-white/10 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleAddSubmit} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-dark-950 border border-white/10 rounded-lg px-3 py-2 text-white outline-none focus:border-gold-500 text-sm"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs uppercase tracking-wider text-gray-400 mb-1 font-bold">Flight Date</label>
                  <input 
                    type="date" 
                    value={date}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-dark-950 border border-gold-500/30 rounded-lg px-3 py-2 text-white outline-none focus:border-gold-400 text-sm cursor-pointer"
                  >
                ...
                <div>
                  ...
                  <input 
                    ...
                    placeholder="e.g. 14F"
                    className="w-full bg-dark-950 border border-white/10 rounded-lg px-3 py-2 text-white focus:border-gold-500 outline-none text-sm uppercase"
                  />
                </div>
                <div>
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-white/10">
                <button
                  type="button"
                  onClick={() => setIsAddOpen(false)}
                  className="bg-white/5 hover:bg-white/10 text-gray-400 border border-transparent px-4 py-2 rounded-lg text-sm transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="bg-gold-500 text-dark-950 font-bold px-5 py-2 rounded-lg text-sm hover:bg-gold-400 hover:shadow-lg transition-all cursor-pointer"
                >
                  Save Passenger
                </button>
              </div>
