...
const initialOffers: Offer[] = [
  ...
  { id: '3', code: 'SWEETFLIGHT', discountType: 'percentage', discountValue: 20, minSpend: 300, categoryId: 'sweet', isActive: false, description: 'Satisfy sweet cravings with 20% flat savings.' },
];
...
export function AdminOffers() {
  ...
  const handleCreateCouponSubmit = (e: React.FormEvent) => {
    ...
    const newOffer: Offer = {
      ...
      isActive: true,
      description: description || `${discountType === 'percentage' ? discountValue + '%' : '₹' + discountValue} off premium in-flight select options.`
    };
  ...
  if (loading) return <div className="text-white p-8">Loading flight vouchers database...</div>;

  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      {/* Header Banner */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-gradient-to-r from-dark-900 to-dark-950 border border-white/10 rounded-2xl p-6 shadow-xl gap-4">
        <div>
          <span className="text-gold-500 text-xs font-mono tracking-widest uppercase mb-1 block">In-flight sales promotions</span>
        ...
        <button 
          ...
          className="flex items-center gap-2 bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-400 hover:to-gold-500 text-dark-950 font-bold px-5 py-3 rounded-xl transition-all shadow-lg text-sm"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {offers.map(off => {
          ...
          return (
            <div 
              key={off.id} 
              className={`border rounded-2xl p-5 bg-dark-900 transition-all ${
                off.isActive 
            ...
            >
              ...
              <div className="bg-white/3 p-3 rounded-xl border border-white/5 space-y-1 text-[11px] text-gray-400 font-mono">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gold-500 font-bold capitalize">
                    {off.categoryId === 'all' ? 'Universal In-flight food' : (matchedCat ? matchedCat.name : off.categoryId)}
                  </span>
                </div>
              </div>
        ...
        {offers.length === 0 && (
          <div className="bg-dark-900 border border-white/10 rounded-2xl p-10 text-center col-span-3 text-gray-500">
      ...
      {isAddOpen && (
        <div className="fixed inset-0 bg-dark-950/85 backdrop-blur-sm flex items-center justify-center p-4 z-[999]">
          <div className="bg-dark-900 border border-white/10 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleCreateCouponSubmit} className="p-6 space-y-4">
              <div>
                <label className="block text-xs uppercase tracking-wider text-gray-400 mb-1 font-bold">In-flight Coupon Code *</label>
                <input 
                  type="text" 
                  value={code}
                  ...
                  className="w-full bg-dark-950 border border-white/10 rounded-lg px-3.5 py-2.5 text-white outline-none focus:border-gold-500 text-sm uppercase font-mono tracking-widest font-bold"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-dark-950 border border-white/10 rounded-lg px-3 py-2 text-white outline-none focus:border-gold-500 text-sm cursor-pointer"
                  >
                ...
                <div>
                  ...
                  <input 
                    ...
                    required
                    placeholder="15"
                    className="w-full bg-dark-950 border border-white/10 rounded-lg px-3 py-2 text-white outline-none focus:border-gold-500 text-sm font-mono font-bold"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    placeholder="499"
                    className="w-full bg-dark-950 border border-white/10 rounded-lg px-3 py-2 text-white focus:border-gold-500 outline-none text-sm font-mono"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows={2}
                  className="w-full bg-dark-950 border border-white/10 rounded-lg px-3 py-2 text-white focus:border-gold-500 outline-none text-sm resize-none"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-white/10">
                ...
                <button
                  type="submit"
                  className="bg-gold-500 text-dark-950 font-bold px-5 py-2 rounded-lg text-sm hover:bg-gold-400 transition-all cursor-pointer"
                >
