...
export function AdminDashboard() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-350">
      {/* Welcome Banner */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-gradient-to-r from-dark-900 to-dark-950 border border-white/10 rounded-2xl p-6 md:p-8 gap-4">
        <div>
          <span className="text-gold-500 text-xs font-mono tracking-widest uppercase mb-1 block">Administrative Control</span>
          <h3 className="text-3xl font-serif text-white">Flight Catering Cockpit</h3>
      ...
      {activeTab === 'overview' ? (
        <div className="space-y-8 animate-in fade-in duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {statCards.map((stat, idx) => (
              <div 
                key={idx} 
                className={`bg-dark-900 border ${stat.accent} rounded-2xl p-6 flex items-center justify-between shadow-lg relative group overflow-hidden`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-dark-900 border border-white/10 rounded-2xl p-6 shadow-xl flex flex-col justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mb-6">Interactive tracking of gross value flow and flight booking logs across the last 6 months.</p>
              </div>
              ...
              <div className="relative w-full">
                ...
                {hoveredMonthIdx !== null && (
                  <div 
                    className="absolute bg-dark-950 border border-gold-500/40 p-3 rounded-lg shadow-2xl animate-in fade-in zoom-in-95 duration-100 pointer-events-none"
                    style={{
            ...
            <div className="lg:col-span-4 bg-dark-900 border border-white/10 rounded-2xl p-6 shadow-xl flex flex-col justify-between">
              <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-dark-900 border border-white/10 rounded-2xl p-6 shadow-xl">
                ...
                {metrics.topDishes.map((dish, i) => (
                  <div key={i} className="py-4 flex items-center justify-between group">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-lg bg-white/5 border border-white/10 overflow-hidden relative shrink-0">
                        {dish.image ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center text-xs text-gold-500 font-bold uppercase">KVR</div>
                        )}
                      </div>
                      <div>
                    ...
                    <div className="text-right">
                      <span className="text-gold-500 font-bold font-mono block text-sm">₹{dish.revenue.toLocaleString()}</span>
                      <span className="text-[10px] text-gray-500 font-mono block gap-1">
                        {Math.round((dish.revenue / (metrics.totalRevenue || 1)) * 100)}% revenue share
                      </span>
                    </div>
                  </div>
                ))}
            ...
            {/* IN-FLIGHT ORDER STATUS DISTRIBUTION */}
            <div className="lg:col-span-4 bg-dark-900 border border-white/10 rounded-2xl p-6 shadow-xl flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2 mb-2">
              ...
              <div className="space-y-4 flex-grow flex flex-col justify-center">
                {Object.keys(metrics.statusBreakdown).map((status, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center justify-between p-3 bg-white/3 border border-white/5 rounded-xl">
                      <div className="flex items-center gap-2.5">
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-200">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
            <div className="bg-dark-900 border border-white/5 rounded-xl p-4 shadow-lg text-center">
            ...
            <div className="col-span-2 lg:col-span-1 bg-dark-900 border border-white/5 rounded-xl p-4 shadow-lg text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-4 bg-dark-900 border border-white/10 rounded-2xl p-6 shadow-xl relative self-start">
              ...
              <form onSubmit={handleAddOfflineSale} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-dark-950/50 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold-500 transition-colors text-sm font-mono"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-dark-950/50 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold-500 transition-colors text-sm"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-dark-950/50 border border-white/10 rounded-lg px-3 py-2.5 text-white focus:outline-none focus:border-gold-500 transition-colors text-xs font-mono"
                    >
                ...
                <button
                  ...
                  className="w-full py-2.5 mt-2 bg-gold-500 text-dark-950 font-semibold uppercase tracking-widest text-xs hover:bg-gold-400 transition-colors rounded-lg cursor-pointer flex items-center justify-center gap-1.5 disabled:opacity-50 font-mono"
                >
                  ...
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-white/5 text-xs text-gray-300">
                      {paginatedSales.map((sale) => (
                        <tr key={sale._id} className="hover:bg-white/2 group transition-colors">
              ...
              <form onSubmit={handleAddOfflineExpense} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Flight culinary purchase"
                    className="w-full bg-dark-950/50 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold-500 transition-colors text-sm"
                  />
                </div>
                  ...
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-white/5 text-xs text-gray-300">
                      {paginatedExpenses.map((expense) => (
                        <tr key={expense._id} className="hover:bg-white/2 group transition-colors">
                          <td className="py-3 px-2 font-mono text-[10px] text-gray-400">
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* DAILY */}
            <div className="bg-dark-900 border border-white/5 rounded-2xl p-6 shadow-xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-4 bg-dark-900 border border-white/10 rounded-2xl p-6 shadow-xl relative">
              ...
              <div className="space-y-4 font-mono text-xs">
                <p className="text-gray-400 leading-relaxed font-sans text-xs">
                  This statement aggregates flight booking transactions processed online (via client ticket payments) as well as sales and expenses logged offline.
                </p>
                ...
                <div className="border-t border-white/5 pt-3">
                  ...
                  <div className="bg-dark-950 p-3 rounded border border-white/5 text-[11px] leading-relaxed text-gray-400">
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-white/5 text-xs text-gray-300">
                    {paginatedPnlBreakdown.map((row) => {
                      ...
                      return (
                        <tr key={row.year} className="hover:bg-white/2 transition-colors">
      ...
      {deleteConfirmSale !== null && (
        <div className="fixed inset-0 bg-dark-950/85 backdrop-blur-md flex items-center justify-center p-4 z-[9999] animate-in fade-in duration-200">
          <div className="bg-dark-900 border border-white/10 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden p-6 space-y-6 animate-in zoom-in-95 duration-200">
