    ...
    <div className="pt-32 pb-32 min-h-screen bg-transparent">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <Reveal className="text-center mb-16">
          ...
          <h1 className="heading-serif text-5xl md:text-6xl text-white">The Cabin Gallery</h1>
        </Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[300px]">
          {items?.map((item: any, i: number) => (
             ...
             >
               ...
               <div className="absolute bottom-0 inset-x-0 p-6 bg-gradient-to-t from-dark-950 to-transparent">
      ...
      <AnimatePresence>
        {lightboxIndex !== null && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] bg-dark-950/95 backdrop-blur-xl flex items-center justify-center p-4"
          >
            <button 
